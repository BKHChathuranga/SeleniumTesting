...
public class CartPageTest extends BaseTest{
	@Test
	public static void increaseCartItemQuantityIntoThree() throws InterruptedException {
	...
	@Test
	public static void increaseCartItemQuantityIntoTwo() throws InterruptedException {
		ProductDisplayPage productDisplayPage = new ProductDisplayPage(driver);
